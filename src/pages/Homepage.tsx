          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <div className="bg-card p-6 rounded-lg shadow-lg border border-border">
                <h2 className="text-2xl font-bold mb-4">Start Your Security Journey</h2>
                <p className="mb-6">
                  Our quiz will test your ability to spot phishing attempts and improve your cybersecurity awareness.
                </p>
                <Button 
